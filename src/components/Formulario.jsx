...
function Formulario() {
    ...
    return (
        <>
            ...
            <p className="text-x mt-5 mb-10 text-center">Añade tus Pacientes {' '}
            ...
            >
                ...
                <div className="mb-5">
                    <label htmlFor="propietario" className="text-gray-700 uppercase font-bold">Nombre propietario/a: </label>
                    <input
                        type="text"
                        id="propietario"
                ...
                <div className="mb-5">
                    <label htmlFor="sintomas" className="text-gray-700 uppercase font-bold">Sintomas Alta: </label>
                    <textarea
                        id="sintomas"
                        className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded "
